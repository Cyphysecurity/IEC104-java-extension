...
public class ASDU implements Serializable {
	...
	public void setFieldName(String name, String value) {
		...
		switch (name) {
		case "iec60870_asdu.typeid": type_id = Integer.parseInt(value);
			break;
		case "iec60870_asdu.sq": sq = Integer.parseInt(value);
			break;
		case "iec60870_asdu.numix": numix = Integer.parseInt(value);
			break;
		case "iec60870_asdu.causetx": causetx = Integer.parseInt(value);
			break;
		case "iec60870_asdu.nega": nega = Integer.parseInt(value);
			break;
		case "iec60870_asdu.test": test = Integer.parseInt(value);
			break;
		case "iec60870_asdu.oa": oa = Integer.parseInt(value);
			break;
		case "iec60870_asdu.addr": addr = Integer.parseInt(value);
			break;
		case "iec60870_asdu.rawdata": rawdata = value;
			break;
		default: break;
		}
