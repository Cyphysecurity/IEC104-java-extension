...
public class PktsStatistics implements APCIControlFieldType {
	...
	public void computeAPCIType(ArrayList<Packet> pkts) {
		...
		System.out.println("Number of malformed packets = " + numMalformedPackets + ", " + numMalformedPackets * 100.0 / cnt_total + "%");
		System.out.println("Number of packets which contain only APCI = " + pkt_apci + ", " + pkt_apci * 100.0 / cnt_total + "%");
		System.out.println("Number of packets which contain APCI + ASDU = " + pkt_asdu + ", " + pkt_asdu * 100.0 / cnt_total + "%");
		System.out.format("Total number of APDUs = %d\n", cnt_apdu);
		System.out.println("number of packets which contain more than one APDUs = " + cnt_multiple_apci + ", " + cnt_multiple_apci * 100.0 / cnt_apdu + "%");
		System.out.println("Number of ASDUs = " + cnt_asdu);
		System.out.println("APCI I type of APDUs = " + cntI + ", " + cntI * 100.0 / cnt_apdu + " %");
		System.out.println("APCI S type of APDUs = " + cntS + ", " + cntS * 100.0 / cnt_apdu + " %");
		System.out.println("APCI U type of APDUs = " + cntU + ", " + cntU * 100.0 / cnt_apdu + "%");
		System.out.println("Number of invalid APCI format APDUs = " + cnt_invalid + ", " + cnt_invalid * 100.0 / cnt_apdu + "%");
