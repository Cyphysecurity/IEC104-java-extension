...
public class APCI implements Serializable {
	...
	public void setFieldValue(String name, String value) {
		...
		switch (name) {
		case "iec60870_asdu.start": start = Integer.parseInt(value);
			break;
		case "iec60870_104.apdulen": apdulen = Integer.parseInt(value);
			break;
		//case "iec60870_104.apdulen_tree": return;  // some JSON has this weird field. e.g. 05_23.json, reason: malformed packets
		case "iec60870_104.type": type = Integer.parseInt(value);
			break;
		case "iec60870_104.tx": tx = Integer.parseInt(value);
			break;
		case "iec60870_104.rx": rx = Integer.parseInt(value);
			break;
		case "iec60870_104.utype": uType = Integer.parseInt(value, 10);
			break;
		default: break;
		}
